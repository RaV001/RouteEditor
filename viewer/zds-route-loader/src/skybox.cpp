...
void Skybox::load(const std::string &routeDir, osg::Group *scene)
{
    ...
    std::string textureDir = combinePath(routeDir, "textures");
    osg::Image *image = loadImage(combinePath(textureDir, "sky_day.bmp"));
    ...
    std::string modelDir = combinePath(routeDir, "models");
    osg::ref_ptr<osg::Node> skymodel = loadSkyModel(combinePath(modelDir, "sky.dmd"));
